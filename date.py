...
KEY = b'xEc6dgy5CmjgLKbzAQZB4BZ2l8QOcLie'
# KEY = exactly 32 bytes
# KEY = secrets.token_bytes(32)

def generate_hash(file_path):
    blake3_hasher = blake3.blake3(key=KEY)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate and verify hashes using the BLAKE3 algorithm with a custom key')
